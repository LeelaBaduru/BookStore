...
/* This class gets triggered when the exception is thrown by a controller which is mapped to the ControllerAdvice method using @ExceptionHandler annotations.
